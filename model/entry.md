...
| AvailableLanguages | IReadonlyCollection&lt;string&gt; | A list languages which have available translations. |
| UnavailableLanguages | IReadonlyCollection&lt;string&gt; | A list languages which the entry can be translated to but have yet to be completed. |
